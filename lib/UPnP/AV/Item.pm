...
sub new {
	...
	$this->{$UPnP::AV::Item::_URL} = '';
	$this->{$UPnP::AV::Item::_CONTENTTYPE} = '';
	bless $this, $class;
}
...
sub setcontenttype() {
	my($this) = shift;
	if (@_) {
		$this->{$UPnP::AV::Item::_CONTENTTYPE} = $_[0];
	}
}
...
The package is a extention UPnP/AV media server, and a sub class of L<UPnP::AV::Content>.
